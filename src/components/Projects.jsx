...
const Projects = () => {
  ...
  return (
    <>
         <div className='relative sm:h-[2000px] md:h-[1280px] lg:h-[1200px] xl:h-[850px] z-10'>
            <div className='absolute inset-0 -z-10' style={BgStyle}></div>
           <div className='absolute inset-0 bg-[#494848]/70 z-10'></div>
            <div className='relative z-20 ml-16 xl:ml-20 '>
                <div className='absolute sm:mt-[4%]  md:mt-[2%] '>
                ...
                <div className='pt-16 grid md:grid-cols-2 xl:grid-cols-3 md:gap-x-4 lg:gap-x-6 gap-y-1 xl:gap-y-0 xl:gap-3 sm:mr-14 md:mr-14 xl:mr-10 '>
                    {projItems.map((item) => (
