  ...
  return (
    <>
      ...
      <div className="pb-2 mb-4  ">
        <h1 className="text-white/90 text-lg font-semibold font-mina">{data.title}</h1>
        <div className='-mx-4 border border-[#666666] md:max-w-[109.5%] lg:w-[108%] xl:w-[108.5%] mt-2 '></div>
      </div>
      
      
      <div className="mb-8 h-[80px] md:h-[150px] lg:h-[120px]">
        <p className="text-[#c7c1c1] text-[16px] font-mina">{data.description}</p>
      </div>
