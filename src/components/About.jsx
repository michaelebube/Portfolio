      ...
      <div className='-z-10 h-[740px] sm:h-[850px] md:h-[600px] xl:h-[650px] sm:bg-gradient-to-b from-[#171717cc] via-[#676464b3] to-[#171717cc]'>
        ...
        <div className='absolute'>
           ...
           <div className='md:flex items-center justify-between'>
            ...
            xl:pt-4 text-sm sm:text-[15px] md:text-[15px] lg:text-[16px] xl:text-[21px]  text-start w-[90%] sm:w-[90%]  md:w-[55%] xl:w-[60%] font-mina leading-loose text-[#BDB9B9]'>I'm a passionate front-end web development student with a solid foundation in HTML, CSS, JavaScript, ReactJS, and TailwindCSS. Eager to keep growing, I'm excited to contribute to a team where I can apply my skills and learn from new challenges. My drive for creating visually appealing, user-friendly websites keeps me exploring innovative tools and techniques. Ready to collaborate and make a meaningful impact on projects!</p>

            <div>
                <img src={profilePic} alt="" className='w-[150px] ml-[25%] sm:w-[250px] pt-7 sm:pt-10 md:pt-0  sm:ml-[25%] md:ml-0 md:max-w-[250px] lg:max-w-[280px]
                xl:max-w-[350px]
